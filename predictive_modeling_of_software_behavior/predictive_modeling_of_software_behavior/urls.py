"""predictive_modeling_of_software_behavior URL Configuration
...
from predictive_modeling_of_software_behavior import settings
...
urlpatterns = [
    ...
    url(r'^Prediction_Of_Software_Behavior/$', remoteuser.Prediction_Of_Software_Behavior, name="Prediction_Of_Software_Behavior"),
    ...
    url(r'^View_Predicted_Software_Behavior_Type_Ratio/$', serviceprovider.View_Predicted_Software_Behavior_Type_Ratio, name="View_Predicted_Software_Behavior_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Software_Behavior_Type/$', serviceprovider.View_Predicted_Software_Behavior_Type, name="View_Predicted_Software_Behavior_Type"),

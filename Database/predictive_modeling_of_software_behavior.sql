...
--
-- Host: localhost
-- Generation Time: Jan 20, 2025 at 01:50 PM
...
--
-- Database: `predictive_modeling_of_software_behavior`
--
CREATE DATABASE IF NOT EXISTS `predictive_modeling_of_software_behavior` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `predictive_modeling_of_software_behavior`;
...
('6wzzq67gvkr6ebima38tq4jc843hgehg', 'eyJ1c2VyaWQiOjJ9:1odsmF:WjWHlHQkW3zO70pMkwVqJMtLM5OET5d05VwiVrXRZVY', '2022-10-13 12:36:31.645750'),
...
('au0nouu0e5nmw0wktf8m29lqduj39ay7', 'eyJ1c2VyaWQiOjJ9:1svGCo:QbZT1nQrue6z5UQlN8Bvl6J5kHrtXuxHENWo2ZZEZc8', '2024-10-14 13:12:50.964583'),
...
('bdm5k0dkfi2zp9i7x8ryhcv2ftez61kz', 'eyJ1c2VyaWQiOjF9:1qbhh8:UzFfMc3J1UahKwaaL2S5hYJ9jGYaQCPbkmjMGH3Qzoc', '2023-09-14 13:26:46.511459'),
...
('dh6jszx7e1lwpwubfe1gf5p8wdho8yke', 'eyJ1c2VyaWQiOjF9:1odrpi:PjNB3dfePzo-AxE7DMvAJHDldMpy_kBL_mwFaQ-6R_M', '2022-10-13 11:36:02.447263'),
...
('yfg4rtxxzta0f96zbxpvd6qi5hfclue0', 'eyJ1c2VyaWQiOjJ9:1qbiPR:3gck6ERIqVS3aqr_HRmJdjofu8FTM0LS1Tk7jdzBeZM', '2023-09-14 14:12:33.008025'),
...
(1, 'Harish', 'Harish123@gmail.com', 'Harish', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,8th Cross,Vijayanagar', 'Male'),
...
(6, 'Multi-label Classification (MLC)', '61.80555555555556'),
(7, 'SVM', '61.458333333333336'),
(8, 'Logistic Regression', '64.93055555555556'),
(9, 'Decision Tree Classifier', '63.541666666666664'),
(10, 'SGD Classifier', '63.541666666666664');
...
--
-- Table structure for table `remote_user_predict_software_behavior`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_software_behavior` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `Numberofratings` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_predict_software_behavior`
--

INSERT INTO `remote_user_predict_software_behavior` (`id`, `Sid`, `Software_Name`, `Package`, `Category`, `Description`, `Rating`, `Numberofratings`, `Prediction`) VALUES
(1, '172.217.10.10-10.42.0.151-443-60663-6', 'Snowfall Live Wallpaper', 'fishnoodle.snowfall_free', 'Personalization', 'Snowfall Live Wallpaper: Wintertime on your home screen!<p>Snowfall is a beautiful live wallpaper featuring gentle snowflakes falling overtop swaying pine trees.  Not a movie, with full support for landscape mode and home screen switching!<p>If you enjoy this, support us by getting the paid version ', '4.3', '18147', 'Good'),
(2, '172.217.10.46-10.42.0.151-443-46646-6', 'Baby Fishing', 'com.sinyee.babybus.seaworld', 'Education', 'Baby bus ,happy childhood.<p>All our products of  Iphone and Android will be free , this product is free now.<p>Tips:In the search bar,enter &quot;sinyee&quot;or &quot;Baby Bus&quot;,you can find all of our products.<p>Baby Fishing is a series of Baby Bus, this is a kind of software of enlightenment', '4.5', '21', 'Bad'),
(3, '10.42.0.211-123.59.190.237-34956-80-6', 'NYC NY City Holiday Guide GPS', 'appinventor.ai_siplink.NYCGuide', 'Travel & Local', 'Dozens of hours researching attractions to minimize the hassle for travelers!<p>Simple to use and cheaper than a cup of coffee!<p>Save hassle, time, money and confusion with research I have already done for you.  Why stress about something you can just buy your way out of?  I have spent dozens of ho', '5', '1', 'Bad'),
(4, '1.31.173.43-10.42.0.42-80-37243-6', 'Dentistry ProConsult', 'edu.mcg.android.dentistryproceduresconsult', 'Medical', 'Dentistry ProConsult is designed for the purpose of providing dental students with a quick and easy way to learn procedures they may have to perform in clinic. <p>The app features: <p>Step-by-step instructions for each procedure <br>A video of each procedure <br>Ability to search procedures <br>Abil', '3.7', '6', 'Bad');
